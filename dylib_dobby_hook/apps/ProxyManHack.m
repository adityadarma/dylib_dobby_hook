...
- (BOOL)hack {
   ...
   // 直接 hook 导入表函数,似乎更优雅
    void* isHideExpireLicenseBadge = sym_solve([MemoryUtils indexForImageWithName:@"ProxymanCore"],           "_$s12ProxymanCore16AppConfigurationC24isHideExpireLicenseBadgeSbvg"
                                     );
    // 记录结束时间
